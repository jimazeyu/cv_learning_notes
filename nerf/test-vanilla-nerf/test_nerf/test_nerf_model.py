...
from test_nerf.test_field import TestNerfField
...
@dataclass
class TestNerfConfig(ModelConfig):
    """Vanilla Model Config"""

    _target: Type = field(default_factory=lambda: TestNerf)
...
class TestNerf(Model):
    ...
    def populate_modules(self):
        ...
        self.field_coarse = TestNerfField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )

        self.field_fine = TestNerfField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )
